...
namespace JWTAppUI.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> List()
        {
            ...
            var response = await client.GetAsync("http://localhost:7055/api/Categories");
        ...
        public async Task<IActionResult> Remove(int id)
        {
            ...
            await client.DeleteAsync($"http://localhost:7055/api/Categories/{id}");
        ...
        public async Task<IActionResult> Create(CategoryCreateRequestModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var response = await client.PostAsync("http://localhost:7055/api/Categories", requestContent);
        ...
        public async Task<IActionResult> Update(int id)
        {
            ...
            var response = await client.GetAsync($"http://localhost:7055/api/Categories/{id}");
        ...
        public async Task<IActionResult> Update(CategoryUpdateRequestModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                HttpResponseMessage response = await client.PutAsync("http://localhost:7055/api/Categories", requestContent);
