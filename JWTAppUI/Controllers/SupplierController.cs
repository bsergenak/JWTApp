...
namespace JWTAppUI.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        public async Task<IActionResult> List()
        {
            ...
            var response = await client.GetAsync("http://localhost:7055/api/Suppliers");
        ...
        public async Task<IActionResult> Remove(int id)
        {
            ...
            await client.DeleteAsync($"http://localhost:7055/api/Suppliers/{id}");
        ...
        public async Task<IActionResult> Create(SupplierCreateRequestModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var response = await client.PostAsync("http://localhost:7055/api/Suppliers", requestContent);
        ...
        public async Task<IActionResult> Update(int id)
        {
            ...
            var response = await client.GetAsync($"http://localhost:7055/api/Suppliers/{id}");
        ...
        public async Task<IActionResult> Update(SupplierUpdateRequestModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var response = await client.PutAsync("http://localhost:7055/api/Suppliers", requestContent);
