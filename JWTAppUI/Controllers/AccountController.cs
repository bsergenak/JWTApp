...
namespace JWTAppUI.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> SignIn(UserLoginModel model)
        {
            ...
            var response = await client.PostAsync("http://localhost:7055/api/Auth/SignIn", requestContent);
        ...
        // API Url = http://localhost:7055/api/Auth/SignIn
        // UI Url = http://localhost:7292/
    }
}
